...
class RequestServiceStub(object):
    ...
    def __init__(self, channel):
        ...
        """
        self.RequestHandler = channel.unary_unary(
...
def add_RequestServiceServicer_to_server(servicer, server):
    rpc_method_handlers = {
            'RequestHandler': grpc.unary_unary_rpc_method_handler(
                    servicer.RequestHandler,
...
class RequestService(object):
    ...
    def RequestHandler(request,
            ...
            timeout=None,
            metadata=None):
        return grpc.experimental.unary_unary(request, target, '/RequestService/RequestHandler',
